...
#ifndef Option6ELSEPA_h
#define Option6ELSEPA_h 1
...
class Option6ELSEPA : public G4VPhysicsConstructor
{
public:

  Option6ELSEPA(G4int ver=1, const G4String& name="");

  virtual ~Option6ELSEPA();
